...
if ( function_exists( 'get_theme_mod' ) ) {
    ...
    $dropdown_style = get_theme_mod( 'themo_dropdown_style', 'dark' ); // Dropdown style.
    ...
    $dropdown_dark_style = false; // Dropdown style.
    if(isset($dropdown_style) && $dropdown_style == 'dark'){
        $dropdown_dark_style = true;
    }
    ...
    // Dropdown style.
    if(isset($dropdown_dark_style) && $dropdown_dark_style ){
        $header_dark_style_class .= ' th-dark-dropdown';
    }else{
        $header_dark_style_class .= ' th-light-dropdown';
    }
    ...
    */
    ...
    if(($themo_post_type == 'page' || $themo_post_type == 'block_template' || $themo_post_type == 'themo_portfolio')
...
<header class="banner navbar navbar-default navbar-static-top <?php echo sanitize_text_field($header_dark_style_class);?>" role="banner" <?php echo sanitize_text_field($transparent_header);?>>
	...
	<div class="container">
        ...
        // Social Icons
        if (function_exists('get_theme_mod')) {
            $woo_cart_header_display = get_theme_mod('themo_nav_social_switch', true);
