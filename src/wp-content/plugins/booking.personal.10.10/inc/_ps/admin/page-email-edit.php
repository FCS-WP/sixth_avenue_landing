...
//FixIn: 8.1.2.17 - END
	    ...
	    $this->fields['subject_before'] = array(
												...
												, 'html' =>  '<tr><td colspan="2">'
															.'<div style="margin: 0 0 15px;font-weight: 600;">'
															 .'<label class="wpbc-form-email-subject" for="' . WPBC_EMAIL_MODIFICATION_ID . '_subject">' .
															 		__( 'Subject', 'booking' )
															 . '</label></div>'
							);
	    ...
	    /* translators: 1: ... */
	    $email_content = sprintf( __( 'The reservation %1$s for: %2$s has been modified. %3$sYou can edit this booking on this page: %4$s  Thank you, %5$s', 'booking' ), '[bookingtype]', '[dates]', '<br/><br/>[content]<br/><br/>', '[visitorbookingediturl]<br/><br/>', $blg_title . '<br/>[siteurl]' );
	    ...
	    $this->fields['content_before'] = array(
												...
												'html'  => '<tr><td colspan="2" style="padding-bottom:0;">'
															   ...
															   . '<label class="wpbc-form-email-content" for="' . WPBC_EMAIL_MODIFICATION_ID . '_content">' .
																   __( 'Content', 'booking' )
															   . '</label></div>'
											);
...
//                    );
        ...
        $subtabs['modification'] = array( 
        					...
        					, 'title' => '<span>' . esc_html__( 'Modified', 'booking' ) . $sufix . '</span>' 					// Title of TAB
                            , 'page_title' => __('Emails Settings', 'booking')  // Title of Page
							...
							, 'checked_data' 			=> WPBC_EMAIL_NEW_ADMIN_PREFIX . WPBC_EMAIL_MODIFICATION_ID				// This is where we get content
                        );
